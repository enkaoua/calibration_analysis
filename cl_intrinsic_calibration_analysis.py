...
def add_recording_args_to_parser(parser):
    ...
    parser.add_argument('--intrinsics_for_he', type=str, default='results/intrinsics/calibration_analysis/R100_N5_60_5_repeats_100_MC_6.0_PC_0.2', help='path to intrinsics results for he')
    return parser
