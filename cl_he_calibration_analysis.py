...
def add_recording_args_to_parser(parser):
    ...
    parser.add_argument('--reprojection_sample_size', type=int, default=100,
                        help='number of samples to use for reprojection error')
    parser.add_argument('--min_num_corners', type=str, default=None,
                        help='minimum number of corners to use for calibration')
    parser.add_argument('--percentage_of_corners', type=float, default=0.2,
    ...
    parser.add_argument('--waitTime', type=int, default=5, help='time to wait before capturing next image')
